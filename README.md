...
wget https://github.com/weiqiang333/scanPort-exporter/releases/download/v1.0/scanPort-exporter-linux-amd64-v1.0.tar.gz
tar -zxf scanPort-exporter-linux-amd64-v1.0.tar.gz -C /usr/local/scanPort-exporter
